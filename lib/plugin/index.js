...
class SupersetPluginChartPieChartCustom extends _core.ChartPlugin {
  /**
  ...
  constructor() {
    var metadata = new _core.ChartMetadata({
      description: 'Superset Plugin Chart Pie Chart Custom',
      name: (0, _core.t)('Pie Chart Custom'),
      thumbnail: _thumbnail.default
    });
    super({
      buildQuery: _buildQuery.default,
      controlPanel: _controlPanel.default,
      loadChart: () => Promise.resolve().then(() => _interopRequireWildcard(require('../SupersetPluginChartPieChartCustom'))),
      metadata,
...
exports.default = SupersetPluginChartPieChartCustom;